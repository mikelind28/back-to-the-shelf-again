...
export default function InstagramEmbed() {
  ...
  return (
    <blockquote
      ...
      data-instgrm-permalink="https://www.instagram.com/backtotheshelfagain/?utm_source=ig_embed&utm_campaign=loading"
    ...
    >
      <div style={{ padding: 16 }}>
        <a
          href="https://www.instagram.com/backtotheshelfagain/?utm_source=ig_embed&utm_campaign=loading"
          style={{
            background: "#FFFFFF",
            lineHeight: 0,
            padding: 0,
        ...
        <p style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: 14, lineHeight: "17px", marginBottom: 0, marginTop: 8, overflow: "hidden", padding: "8px 0 7px", textAlign: "center", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
          <a
            href="https://www.instagram.com/backtotheshelfagain/?utm_source=ig_embed&utm_campaign=loading"
            style={{ color: "#c9c8cd", fontFamily: "Arial,sans-serif", fontSize: 14, fontStyle: "normal", fontWeight: "normal", lineHeight: "17px" }}
            target="_blank"
            rel="noreferrer"
          >
