...
function Section({
  ...
  return (
    <div
      className={`flex w-full flex-col items-center gap-6 px-6 py-10 md:gap-10 ${bgColorMain}`}
    >
      <H1 line1={headerLine1} line2={headerLine2} />
      <div
        className={`${bgColorLight} rounded-md px-6 pt-4 pb-6 sm:px-8 sm:pt-6 sm:pb-8 md:px-12 md:pt-8 md:pb-10`}
      >
        {children}
      </div>
      {dividerColor && (
...
export default function About() {
  return (
    ...
    >
      ...
      >
        <div className="flex max-w-150 flex-col gap-3 md:gap-5">
          <p
            className={`${titleHeader.className} text-center text-2xl/8 md:text-3xl/9`}
          >
            Every great romance deserves a second chance.
          </p>
          <p>
      ...
      >
        <div className="flex max-w-150 flex-col gap-3 md:gap-5">
          ...
          <p>
            ...
            every dog-eared page, handwritten note, and well-loved spine carries
            the magic of the readers before you.
          </p>
          <p>
      ...
      >
        <div className="flex w-full flex-col gap-5 md:flex-row md:items-end">
          <Image
            src="/emily.webp"
            alt={"Emily"}
            width={500}
            ...
            loading="eager"
          />
          <div className="flex max-w-90 flex-col items-center gap-3 pb-4">
            <p className={`${titleHeader.className} text-2xl/8 md:text-3xl/9`}>
              Hi, I’m Emily.
            </p>
            <p>
              ...co-owner of Back to the Shelf Again. I’m a Lodi native, a wife,
              and a mom of two girls—and a lifelong book lover who started her
              reading journey with The Bailey School Kids and a full-blown Harry
              Potter obsession. Like a lot of us, life, college, and career
              pulled me away from reading for a while… until Molly, BTTSA
              co-owner, handed me a fantasy-romance novel and basically
      ...
      >
        <div className="flex flex-col items-center gap-5 md:flex-row-reverse md:items-end">
          <Image
            src="/molly.webp"
          ...
          <div className="flex max-w-90 flex-col items-center gap-3 pb-4">
            ...
            <p>
              ...
              creating a space for readers to celebrate the joy that comes from
